...
void stack_like(){
  ...
  //TH1F * ratio_d = (TH1F*)f1->Get("ratio_d");
  ...
  //legend->AddEntry(ratio_d,"Total Data");
  stack->Add(ratio_c);
  stack->Add(ratio_g);
  stack->Add(ratio_w);
  stack->Add(ratio_n);
